...
import static fr.kubys.leekscriptv4.parser.LeekScriptParserUtil.*;
...
public class LeekScriptParser implements PsiParser, LightPsiParser {
  ...
  public static boolean argumentList(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, LeekScriptParser::singleExpressionRecover);
    return r;
  }
  ...
  static boolean singleExpressionPart(PsiBuilder b, int l) {
    ...
    r = singleExpression(b, l + 1);
    exit_section_(b, l, m, r, false, LeekScriptParser::singleExpressionPartRecover);
    return r;
  }
